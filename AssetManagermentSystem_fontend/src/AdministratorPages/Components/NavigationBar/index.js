    ...
    const UserBoard = () => {
        return (<span className="board-info">
            <Row
                className="menu-item">
                <Col span={3}>
                    <Avatar shape="circle" className="avatar" size={32} src={userInfoLogin ? userInfoLogin.Image : ""} />
                </Col>
    ...
    return (
        <Row className="navbar">
            ...
            <Col span={10} className="nav-bar-right">
                <span className="nav-bar-item ams-btn">
                    <Popover placement="bottomRight" content={<ListEmployee />} trigger="click">
                ...
                <span className="nav-bar-item ams-btn">
                    <Popover placement="bottom" content={<UserBoard />} trigger="click">
                        <Avatar shape="circle" className="avatar" size={32} src={userInfoLogin?.Image} />
                    </Popover>
                </span>
            </Col>
        </Row>
